...
processor = OptitrackProcessor()
print(processor.recv_data(rigid_body_ids=None))
processor.close()
# print(processor.recv_data(rigid_body_ids=None)) # Should fail if uncommented, socket has been closed
